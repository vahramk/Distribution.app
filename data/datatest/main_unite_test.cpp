...
int main()
{
    ...
    QString ff = "c:/pivot.csv";
	CCSVParser csv(ff);
	IDataTable* t = csv.parse();
	std::cout<<"r: "<<t->getRowCount()<<" c: "<<t->getColumnCount()<<std::endl;
    std::cout<<" n: "<<t->getColumn(13)->getName().toStdString()<<std::endl;
    QString str;
	double d;
    ...
    std::cout<<"last element: "<<str.toStdString()<<" c: "<<d<<" dt: "<<buf<<std::endl;
    ...
    std::cout<<" n: "<<t1->getColumn(13)->getName().toStdString()<<std::endl;
    QString str1;
	double d1;
    ...
    std::cout<<"last element: "<<str1.toStdString()<<" c: "<<d1<<" dt: "<<buf1<<std::endl;
